...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://doctorsapp-backend-w03l.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
